...
const getLatestResume = async (accessToken, userId) => {
...
// Remove skill
router.delete('/skills/:skill', authenticateToken, async (req, res) => {
    try {
...
router.get('/completeness', authenticateToken, async (req, res) => {
    try {
        const client = createAuthedSupabaseClient(req.accessToken);
