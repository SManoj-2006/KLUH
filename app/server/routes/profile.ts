...
// Add skill
router.post('/skills', authenticateToken, (req: AuthRequest, res) => {
  try {
...
// Remove skill
router.delete('/skills/:skill', authenticateToken, (req: AuthRequest, res) => {
  try {
...
router.get('/completeness', authenticateToken, (req: AuthRequest, res) => {
  try {
    const profile = db.getProfile(req.user!.id);
